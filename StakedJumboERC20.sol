...
contract StakedJumboERC20 is ERC20Permit, IStakedJumboERC20, Ownable {
    ...
    constructor() ERC20("Staked Jumbo", "sJUB", 9) ERC20Permit() {
    ...
    function balanceOf( address who ) public view override(ERC20, IStakedJumboERC20) returns ( uint256 ) {
